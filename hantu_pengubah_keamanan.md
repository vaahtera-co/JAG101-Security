...
This repository is used to document my journey on getting a better foundational knowledge of "Cyber Security".

The reason for documenting these days is so that others can take something from it and also hopefully enhance the resources.

This will **not cover all things** "Cyber Security" but it will cover the areas that I feel will benefit my learning and understanding overall.

<!-- [![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/N4N33YRCS) -->

The quickest way to get in touch is going to be via Website, my handle is [@vaahtera](https://vaahtera.my.id/)
